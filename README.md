...
- **사이트가 느릴 때**: 방문이 길어지는 원인은 동시 접속이 아니라 대상 사이트의 응답 속도입니다(느린 사이트는 혼자 방문해도 200초를 넘겼습니다). 첫 도착에 45초가 넘게 걸렸거나 남은 시간이 90초 미만이면 모바일 재방문을 건너뛰고 리뷰와 점검표를 지킵니다. 리포트 점검표 머리에 "모바일 재방문은 시간 부족으로 생략"이라고 적힙니다.
